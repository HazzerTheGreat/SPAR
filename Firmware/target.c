...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM1, CH1, PA8, TIM_USE_OUTPUT_AUTO, 0, 4),   // S5
    DEF_TIM(TIM4, CH3, PD14, TIM_USE_OUTPUT_AUTO, 0, 5),   // S6

    DEF_TIM(TIM4, CH4, PD15, TIM_USE_OUTPUT_AUTO, 0, 6),   // S7
    DEF_TIM(TIM8, CH1, PC6, TIM_USE_OUTPUT_AUTO, 0, 7),   // S8
    DEF_TIM(TIM8, CH2, PC7, TIM_USE_OUTPUT_AUTO, 0, 9),   // S9
    DEF_TIM(TIM8, CH4, PC9, TIM_USE_OUTPUT_AUTO, 0, 10),   // S10 

    DEF_TIM(TIM15,  CH1, PE5,  TIM_USE_LED, 0, 9),    // LED_2812
    DEF_TIM(TIM15,  CH2, PE6,  TIM_USE_LED, 0, 9),    // LED_2812
};
